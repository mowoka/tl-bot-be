...
export const count_kpi = (user: User): UserResult => {
    ...
    return {
        ...user,
        ticket_lapor_langsung: { name: 'laporlangsung', score: kpi_lapor_langsung },
        ticket_tutup_odp: { name: 'tutupodp', score: kpi_tutup_odp },
        ticket_regular: { name: 'tiketreguler', score: kpi_tiket_reguler },
        ticket_sqm: { name: 'tiketsqm', score: kpi_sqm },
        ...
        ticket_kendala_sqm: { name: 'tiketkendalasqm', score: kpi_kendala_sqm },
        ticket_bantek: { name: 'tiketbantek', score: kpi_bantek },
        ticket_infra: { name: 'tiketinfra', score: kpi_infra },
        ticket_us: { name: 'tiketus', score: kpi_us },
        ticket_gaul_reguler: { name: 'tiketgaulreguler', score: kpi_gaul_reguler },
        ticket_gaul_sqm: { name: 'tiketgaulsqm', score: kpi_gaul_sqm },
        ticket_gaul_us: { name: 'tiketgaulus', score: kpi_gaul_us },
        gamas_type_a: { name: 'gamastipea', score: kpi_gamas_type_a },
        gamas_type_b: { name: 'gamastipeb', score: kpi_gamas_type_b },
        gamas_type_c: { name: 'gamastipec', score: kpi_gamas_type_c },
